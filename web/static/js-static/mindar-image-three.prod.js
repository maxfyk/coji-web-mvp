...
import { t as A, C as R } from "./controller.7172d577.js";
...
class H {
  constructor({
    ...
    this.container = h, this.imageTargetSrc = i, this.maxTrack = s, this.filterMinCF = n, this.filterBeta = e, this.warmupTolerance = o, this.missTolerance = l, this.ui = new I({ uiLoading: t, uiScanning: r, uiError: a }), this.scene = new v(), this.cssScene = new v(), this.renderer = new M({ antialias: !0, alpha: !0 }), this.cssRenderer = new E({ antialias: !0 }), this.renderer.outputEncoding = b, this.renderer.setPixelRatio(window.devicePixelRatio), this.camera = new T(), this.anchors = [], this.renderer.domElement.style.position = "absolute", this.cssRenderer.domElement.style.position = "absolute", this.container.appendChild(this.renderer.domElement), this.container.appendChild(this.cssRenderer.domElement), window.addEventListener("resize", this.resize.bind(this));
  }
  async start() {
...
window.MINDAR.IMAGE.MindARThree = H;
